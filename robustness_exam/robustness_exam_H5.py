...
def run_h5_robustness(hv_df):
    """
    H5 robustness:
    Pet species and HVLE formation among high-value customers.

    The main adjusted model excludes order_unit_price because high-value
    ...
    print("=" * 70)
    print("=== H5 Robustness: Pet Species and HVLE Formation ===")
    print("=" * 70)
    print("Prepared high-value sample size:", len(df))

    print("\nPet species distribution:")
    print(df["pet_species_label"].value_counts().to_string())
    ...
    print("\n" + "=" * 70)
    print("H5 key pet-species coefficients across models")
    print("=" * 70)
...
if __name__ == "__main__":
    ...
    run_h5_robustness(hvle_data["hv_df"])
