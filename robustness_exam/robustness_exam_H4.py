...
def run_h4_robustness(hv_df):
    ...
    print("=" * 70)
    print("=== H4 Robustness: Purchase Structure and HVLE Formation ===")
    print("=" * 70)
    print("Prepared high-value sample size:", len(df))

    print("\nPurchase structure distribution:")
    print(df["purchase_structure_binary"].value_counts().to_string())
    ...
    print("\n" + "=" * 70)
    print("H4 key purchase-structure coefficients across models")
    print("=" * 70)
...
if __name__ == "__main__":
    ...
    run_h4_robustness(hvle_data["hv_df"])
